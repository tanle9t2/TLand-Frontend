            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="px-6 pt-6 pb-4 border-b border-gray-100">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-[1.7rem] font-semibold text-gray-900">Vị trí bất động sản</h2>
                            <p className="text-[1.2rem] text-gray-400">Mã căn và phân khu giúp xác định chính xác</p>
                        </div>
                    </div>
                </div>
                <div className="p-6">
                ...
                <div className="px-6 pt-6 pb-4 border-b border-gray-100">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[1.2rem] text-gray-400">Mô tả đặc điểm của bất động sản</p>
                        </div>
                    </div>
                </div>
                <div className="p-6 space-y-5">
                    ...
                    {category && (
                        <div>
                            <label className={labelClass}>
                                Loại hình {category.name} <span className="text-rose-500">*</span>
                            </label>
                    ...
                    {category.name !== "Đất" && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                <label className={labelClass}>Số phòng vệ sinh <span className="text-rose-500">*</span></label>
                                <input
                                    type="number"
                                    min={0}
                                    {...register("bathrooms", { required: "Vui lòng nhập số phòng tắm" })}
                                    className={inputClass}
                                    placeholder="0"
                                />
                            </div>
                            ...
                            <div>
                                <label className={labelClass}>Tổng số tầng <span className="text-rose-500">*</span></label>
                                <input
                                    min={0}
                                    type="number"
                                    {...register("floors", { required: "Vui lòng nhập số tầng" })}
                                    className={inputClass}
                                    placeholder="0"
                                />
                            </div>
                ...
                <div className="px-6 pt-6 pb-4 border-b border-gray-100">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[1.2rem] text-gray-400">Pháp lý, nội thất và tiện ích</p>
                        </div>
                    </div>
                </div>
                <div className="p-6 space-y-5">
                ...
                <div className="px-6 pt-6 pb-4 border-b border-gray-100">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[1.2rem] text-gray-400">Thông tin về kích thước bất động sản</p>
                        </div>
                    </div>
                </div>
                <div className="p-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            <label className={labelClass}>Chiều ngang (m) <span className="text-rose-500">*</span></label>
                            <input
                                type="number"
                                step="any"
                                {...register("width", { valueAsNumber: true, required: "Vui lòng nhập chiều ngang" })}
                                className={inputClass}
                                placeholder="VD: 5"
                            />
                        </div>
                        <div>
                            <label className={labelClass}>Chiều dài (m) <span className="text-rose-500">*</span></label>
                            <input
                                type="number"
                                step="any"
                                {...register("length", { valueAsNumber: true, required: "Vui lòng nhập chiều dài" })}
                                className={inputClass}
                                placeholder="VD: 20"
                            />
                        </div>
